    ...
    <script src="<?php echo base_url('public/material/global/vendor/asprogress/jquery-asProgress.js')?>"></script>
    <script src="<?php echo base_url('public/material/global/vendor/draggabilly/draggabilly.pkgd.js')?>"></script>
    <script src="<?php echo base_url('public/material/global/vendor/raty/jquery.raty.js')?>"></script>
    ...
    <script src="<?php echo base_url('public/material/global/js/Plugin/responsive-tabs.js')?>"></script>
    <script src="<?php echo base_url('public/material/global/js/Plugin/tabs.js')?>"></script>
    <script src="<?php echo base_url('public/material/global/js/Plugin/asprogress.js')?>"></script>
    <script src="<?php echo base_url('public/material/global/js/Plugin/panel.js')?>"></script>
    <script src="<?php echo base_url('public/material/global/js/Plugin/asscrollable.js')?>"></script>
    <script src="<?php echo base_url('public/material/global/js/Plugin/raty.js')?>"></script>
    
    <script src="<?php echo base_url('public/material/topbar/assets/examples/js/uikit/panel-structure.js')?>"></script>
